        ...
        setupPaging: function() {
          ...
          if (slider.pagingCount > 1) {
            for (var i = 0; i < slider.pagingCount; i++) {
              ...
              item = (slider.vars.controlNav === "thumbnails") ? '<images src="' + slide.attr( 'data-thumb' ) + '"' + altText + '/>' : '<a href="#">' + j + '</a>';
      ...
      if (dataOnly) {
        ...
        while (n < x) {
          ...
          if (showImages && images[n] !== undefined) {
            op += '<div class="media">' +
                '<images src="' + extractImageUrl(images[n]) +
    ...
    var Jarallax = (function () {
        ...
        function Jarallax_inner (item, userOptions) {
            ...
            _this.image      = {
                ...
                // use <images> instead of background image - more smoothly
