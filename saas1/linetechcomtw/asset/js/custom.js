(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.main-nav.in', function (e) {
            if ($(e.target).is('span') && !$(e.target).parent().hasClass('has-submenu')) {
                $(this).collapse('hide');
        ...
        $('.flexslider').flexslider({
            ...
            before: function (slider) {
                $('.hero-caption').fadeOut().animate({ top: '-80px' }, { queue: false, easing: 'swing', duration: 0 });
                slider.slides.eq(slider.currentSlide).delay(0);
                slider.slides.eq(slider.animatingTo).delay(0);
            },
            after: function (slider) {
                $('.hero-caption').fadeIn().animate({ top: '0' }, { queue: false, easing: 'swing', duration: 0 });
            },
            useCSS: true
        });
